...
// ── Social Cards ──────────────────────────────────
const socialCards = [
  { icon: '📘', name: 'Facebook', bg: '#1877f2', v1: '10k',  l1: 'Friends',   v2: '459',   l2: 'Feeds'    },
  { icon: '🐦', name: 'Twitter',  bg: '#1da1f2', v1: '9K', l1: 'Followers', v2: '1,792', l2: 'Tweets'   },
  { icon: '💼', name: 'LinkedIn', bg: '#2563eb', v1: '500',  l1: 'Contacts',  v2: '1,292', l2: 'Feeds'    },
  { icon: '📅', name: 'Events',   bg: '#f59e0b', v1: '5+',  l1: 'Events',    v2: '4',     l2: 'Meetings' },
]
...
const users = [
  { name: 'Teo Em',  type: 'New',       registered: 'Jan 10, 2024', flag: '🇺🇸', usage: 50, usageColor: '#10b981', period: 'Jun–Jul 2024', payment: 'Mastercard', lastLogin: '10 seconds ago', status: 'Active',   avatarColor: '#6366f1' },
  ...
  { name: 'Messi',     type: 'New',       registered: 'Jan 10, 2024', flag: '🇫🇷', usage: 98, usageColor: '#ef4444', period: 'Jun–Jul 2024', payment: 'PayPal',     lastLogin: '1 week ago',     status: 'Inactive', avatarColor: '#8b5cf6' },
  { name: 'Ronaldo',  type: 'New',       registered: 'Jan 10, 2024', flag: '🇪🇸', usage: 22, usageColor: '#8b5cf6', period: 'Jun–Jul 2024', payment: 'Apple Pay',  lastLogin: '3 months ago',   status: 'Active',   avatarColor: '#ec4899' },
  { name: 'Bo PC',   type: 'New',       registered: 'Jan 10, 2024', flag: '🇵🇱', usage: 43, usageColor: '#10b981', period: 'Jun–Jul 2024', payment: 'Amex',       lastLogin: '1 year ago',     status: 'Active',   avatarColor: '#14b8a6' },
